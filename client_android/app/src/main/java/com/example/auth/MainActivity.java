        ...
        protected void onPostExecute(JSONObject result) {
            ...
            try {
                if (result != null) {
                    ...
                    dash.putExtra("name", editName.getText().toString());
                    startActivity(dash);
                } else {
                    Toast.makeText(getApplicationContext(), "Impossible de récupérer les données du serveur", Toast.LENGTH_LONG).show();
                }
